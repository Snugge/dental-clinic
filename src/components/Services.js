    ...
    return (
        <div className="m-5 " >
            ...
            <div className="card-group container">
                <div className="card m-2 col-md-3 shadow-5-strong rounded-3 text-center">
                    <div className="card-body my-4">
                        <img src="./image/icons/icon-1.svg" alt="Icon" className="service-icon mb-4" />
                ...
                <div className="card m-2 col-md-3 shadow-5-strong rounded-3 text-center">
                    <div className="card-body my-4">
                        <img src="./image/icons/icon-2.svg" alt="Icon" className="service-icon mb-4" />
                ...
                <div className="card m-2 col-md-3 shadow-5-strong rounded-3 text-center">
                    <div className="card-body my-4">
                        <img src="./image/icons/icon-3.svg" alt="Icon" className="service-icon mb-4" />
            ...
            <div className="card-group container">
                <div className="card m-2 col-md-3 shadow-5-strong rounded-3 text-center">
                    <div className="card-body my-4">
                        <img src="./image/icons/icon-4.svg" alt="Icon" className="service-icon mb-4" />
                ...
                <div className="card m-2 col-md-3 shadow-5-strong rounded-3 text-center">
                    <div className="card-body my-4">
                        <img src="./image/icons/icon-5.svg" alt="Icon" className="service-icon mb-4" />
                ...
                <div className="card m-2 col-md-3 shadow-5-strong rounded-3 text-center">
                    <div className="card-body my-4">
                        <img src="./image/icons/icon-6.svg" alt="Icon" className="service-icon mb-4" />
